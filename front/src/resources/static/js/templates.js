const templates = {
  ...
  createChatItem: ({ name, initial, avatarUrl, messageTime, messageValue }) => {
  ...
  defaultChatEditor: () => {
    ...
    <div class="connectly-container">
          ...
          >
            <g>
              ...
              <rect
                ...
                fill="#e6e6e6"
              />
              <circle cx="556.46311" cy="24.26412" r="6.82878" fill="#e6e6e6" />
              <circle cx="575.24227" cy="24.26412" r="6.82878" fill="#e6e6e6" />
              <circle cx="594.02142" cy="24.26412" r="6.82878" fill="#e6e6e6" />
              <path
              ...
              />
              <path
                id="uuid-9e40be56-d004-4de8-84cd-e8041855938b-372"
              ...
              <g>
                <path
                  id="uuid-73aedec7-8a7b-498d-9bbc-62d5085a8040-373"
              ...
              <g>
                <path
                  id="uuid-8e851e4b-a66f-4616-8a31-24a5e3f3093d-374"
              ...
              <g>
                <path
                  id="uuid-35301953-803a-439b-9845-5bf97a98fdf5-375"
        ...
        <div class="connectly-info" style="opacity: 1">
          <h1 class="connectly-header">Connectly Messages</h1>

          <div class="connectly-description">
            Send and receive messages instantly across your devices.<br />
            Stay in touch with friends, family, and colleagues anytime,
            anywhere.
          </div>
        </div>
      </div>
  ...
  chatEditor: () => {
    ...
    editor.className = 'chat-container'
    editor.tabIndex = 0
    editor.innerHTML = `
